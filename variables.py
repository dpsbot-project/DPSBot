...
def gamerefresh():
    gamename.reset()
    gamename.append(trans.gettext(_("DPSBot!")))
    gamename.append(_("type %s help!") % prefixvalue)
    gamename.append(_("type %s info!") % prefixvalue)
    gamename.append(trans.gettext(_("Made by DPS0340")))
    gamename.append(trans.gettext(_("dpsbot.tk")))
    gamename.append(trans.gettext(_("github.com/DPS0340/DPSbot")))
    gamename.append(trans.gettext(_("teamttakkku.tk")))
    gamename.append(trans.gettext(_("Proudly Powered by Team ttakkku")))
