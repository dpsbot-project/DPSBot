...
if __name__ == "__main__":
    ...
    cur.execute("INSERT INTO settings VALUES('instruction', 'a open source discord bot.') ON CONFLICT (name) DO UPDATE SET name='instruction', body='a open source discord bot.'")
    cur.execute("INSERT INTO settings VALUES('game', 'github/DPS0340/DPSBot') ON CONFLICT (name) DO UPDATE SET name='game', body='github/DPS0340/DPSBot'")
    conn.close()
